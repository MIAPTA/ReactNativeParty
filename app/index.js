...
const App = () => {
  ...
  useEffect(() => {
    const saveData = async () => {
      await AsyncStorage.setItem('userId', isId);
      await AsyncStorage.setItem('userName', isName);
      await AsyncStorage.setItem('isLoggedIn', isLogin.toString());
      await AsyncStorage.setItem('userType', isType);
    };
    saveData();
